...
export { Point, Range, Focus, Alignment, DefaultAlignment, HeaderAlignment, TableCell, TableRow, Table, readTable, FormatType, completeTable, formatTable, alterAlignment, insertRow, deleteRow, moveRow, insertColumn, deleteColumn, moveColumn, Insert, Delete, applyEditScript, shortestEditScript, ITextEditor, options, TableEditor };
